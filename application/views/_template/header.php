...
<head>
    <base href="<?php echo base_url(); ?>assets/theme/dist">
    <title>PT. GOLDEN ISLAND GROUP</title>
    ...
    <script src="dist/assets/js/custom/modals/create-app.js"></script>
    <script src="dist/assets/js/custom/modals/upgrade-plan.js"></script>
...
<body id="kt_body" style="background-image: url(dist/assets/media/patterns/header-bg-dark.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
    <!--begin::Main-->
    <!--begin::Root-->
                    ...
                    <div class="container d-flex align-items-center">
                        ...
                        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
                            <a href="../../demo2/dist/index.html">
                                <img alt="Logo" src="dist/assets/media/logos/logo-4.png" class="logo-default h-25px" />
                                <img alt="Logo" src="dist/assets/media/logos/logo-5.png" class="logo-sticky h-25px" />
                            </a>
                        </div>
                        <!--end::Header Logo-->
                        <!--begin::Wrapper-->
                                                ...
                                                ?>
                                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                        <span class="menu-link py-3">
                                                            ...
                                                            <span class="menu-title"><?php echo $row->APLIKASI_NAMA; ?></span>
                                                        ...
                                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                            ...
                                                            ?>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3" href="<?php echo base_url(); ?><?php echo $row->APLIKASI_LINK; ?>/<?php echo $menu->MENU_LINK; ?>">
                                ...
                                <div class="topbar d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                        ...
                                        <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                                            <img class="h-25px w-25px rounded" src="<?php echo base_url(); ?>uploads/user/<?= detail_user()[0]->USER_FOTO ?>" alt="" />
                                        </div>
                                        <!--begin::Menu-->
                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content d-flex align-items-center px-3">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <img alt="Logo" src="<?php echo base_url(); ?>uploads/user/<?= detail_user()[0]->USER_FOTO ?>" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Username-->
                                                    <div class="d-flex flex-column">
                                                        <div class="fw-bolder d-flex align-items-center fs-5"><?= detail_user()[0]->USER_NAMA ?>
                                                        </div>
                                                        <a class="fw-bold text-muted text-hover-primary fs-7"><?= detail_user()[0]->USER_USERNAME ?></a>
                                                    </div>
                                                    <!--end::Username-->
                                                </div>
                                            </div>
