        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-13 text-center">
                    ...
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="text-muted fw-bold fs-5">Tambah / Edit Menu
                    </div>
                    <!--end::Description-->
                </div>
                <form id="submit">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <select class="form-select form-select-solid aplikasi" data-control="select2" data-hide-search="true" data-placeholder="Pilih Aplikasi" name="aplikasi" id="aplikasi">
                        </select>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
...
<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bolder my-1 fs-3">Menu</h1>
            <!--end::Title-->
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li class="breadcrumb-item text-white opacity-75">Menu</li>
            </ul>
        </div>
        <!--end::Page title-->
        <div class="d-flex align-items-center py-3 py-md-1">
            ...
            <!--end::Wrapper-->
            <!--begin::Button-->
            <a class="btn_menu btn btn-bg-white btn-active-color-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button">Menu Baru</a>
            <!--end::Button-->
        </div>
        <!--end::Actions-->
                ...
                if (data.length === 0) {} else {
                    ...
                    for (i = 0; i < data.length; i++) {
                        $("tbody#zone_data").append("<tr class=''>" +
                            ...
                            "<td><a class='btn btn-danger mb-2 btn-sm' onclick='hapus(\"" + data[i].MENU_ID + "\")'><i class='fas fa-trash'></i> Hapus</a> " +
                            "<a class='btn btn-warning mb-2 btn-sm' onclick='detail(\"" + data[i].MENU_ID + "\")'><i class='fas fa-edit'></i> Edit</a></td>" +
                            "</tr>");
                    }
                }
            },
