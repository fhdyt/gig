        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="mb-13 text-center">
                    ...
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="text-muted fw-bold fs-5">Tambah / Edit Supplier
                    </div>
                    <!--end::Description-->
                </div>
                <form id="submit">
...
<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
        ...
        <div class="d-flex align-items-center py-3 py-md-1">
            ...
            <!--end::Wrapper-->
            <!--begin::Button-->
            <a class="btn_supplier btn btn-bg-white btn-active-color-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button">Supplier Baru</a>
            <!--end::Button-->
        </div>
        <!--end::Actions-->
        <!--end::Page title-->
                ...
                if (data.length === 0) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        $("tbody#zone_data").append("<tr class=''>" +
                            ...
                            "<td><a class='btn btn-danger btn-sm mb-2' onclick='hapus(\"" + data[i].MASTER_SUPPLIER_ID + "\")'><i class='fas fa-trash'></i> Hapus</a> " +
                            "<a class='btn btn-warning btn-sm mb-2' onclick='detail(\"" + data[i].MASTER_SUPPLIER_ID + "\")'><i class='fas fa-edit'></i> Edit</a> " +
                            "</tr>");
                    }
                }
            },
